...
import com.santodev.springcoredemo.beans.MyBean;
import com.santodev.springcoredemo.beans.PrototypeBean;
import com.santodev.springcoredemo.beans.SingletonBean;
...
public class SpringCoreDemoApplication {
	...
	public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(SpringCoreDemoApplication.class, args);
        System.out.println("____________________________________");
        System.out.println("Starting Spring Boot Application...");

        System.out.println("\nRequesting beans from container...");

        MyBean singletonBean = context.getBean(SingletonBean.class);
        MyBean prototypeBean = context.getBean(PrototypeBean.class);
